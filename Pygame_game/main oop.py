...
enemy = enemy_a(800, 703, 22, 33, 15)
enemy_2 = enemy_a(15, 703, 22, 33,900)
...
while run:
    ...
    if enemy.dead == False:
        ...
        if prot.isMelee == True and abs(prot.x - enemy.x) < 30 and prot.isJump ==False:
            enemy.isMelee = False
            enemy.hurt = True
            enemy.health -= 1
    ...
    #### Enemy 2 ####
        if enemy_2.dead == False:
            ...
            if prot.isMelee == True and abs(prot.x - enemy_2.x) < 30 and prot.isJump==False:
                enemy_2.isMelee = False
                enemy_2.hurt = True
                enemy_2.health -= 1
